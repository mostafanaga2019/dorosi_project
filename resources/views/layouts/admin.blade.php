    ...
    <body data-sidebar="dark" dir="rtl">
         ...
         <div id="layout-wrapper">
            <x-jet-banner />
                ...
                <nav  style="position: fixed;z-index: 2000;width:100%;"  x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    @if (isset($header))
                            <header  class="bg-white shadow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">                                     
                                 {{ $header }}                                             
                            </header>
                    @endif 
                </nav> 
